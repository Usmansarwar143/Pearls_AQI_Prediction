...
def generate_predictions():
    ...
    if hf_api_key:
        ...
        current_aqi = float(latest_row['aqi'].values[0])
        prompt = f"<|system|>\nYou are an expert meteorologist analyzing air quality for Sadiqabad, Pakistan. Do not use markdown or bullet points. Keep it strictly to 2-3 short sentences.</s>\n<|user|>\nThe current AQI is {current_aqi:.1f}. The 1-day forecast is {pred_1d:.1f}, 2-day is {pred_2d:.1f}, 3-day is {pred_3d:.1f}. Provide a concise plain-English health advisory and forecast summary.</s>\n<|assistant|>\n"
